                                ...
                                <div key={index} className="flex flex-col md:flex-row md:items-center md:justify-between shadow-md md:p-5 p-2 mb-4">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-row md:justify-start justify-end items-center mt-2">
                                            ...
                                            <button onClick={() => handleQuantity('increment', item.id)} className="size-6 flex items-center justify-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary hover:text-white">
                                                +
                                            </button>
                                            <div className="ml-5">
